    ...
    <>
      <article className='bg-white m-4 rounded-md px-5 py-2 border border-gray-100 shadow-md flex justify-center items-center'>
        ...
        <section className='flex flex-col text-[#262b40]'>
          ...
          <a href={userData.url} target="_blank" className="bg-[#333] rounded-md flex text-[#f5f5f5] w-fit items-center justify-center px-2 py-1 font-bold self-center mb-2"><Icon icon="ion:logo-github" className='mr-2 w-5 h-5' /> GitHub</a>
